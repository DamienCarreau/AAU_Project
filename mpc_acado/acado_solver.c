...
acadoWorkspace.objValueIn[0] = acadoVariables.x[25];
acadoWorkspace.objValueIn[1] = acadoVariables.x[26];
acadoWorkspace.objValueIn[2] = acadoVariables.x[27];
acadoWorkspace.objValueIn[3] = acadoVariables.x[28];
acadoWorkspace.objValueIn[4] = acadoVariables.x[29];
...
{
acadoWorkspace.H[(iRow * 20) + (iCol * 2)] += + Gu1[0]*Gu2[0] + Gu1[2]*Gu2[2] + Gu1[4]*Gu2[4] + Gu1[6]*Gu2[6] + Gu1[8]*Gu2[8];
acadoWorkspace.H[(iRow * 20) + (iCol * 2 + 1)] += + Gu1[0]*Gu2[1] + Gu1[2]*Gu2[3] + Gu1[4]*Gu2[5] + Gu1[6]*Gu2[7] + Gu1[8]*Gu2[9];
acadoWorkspace.H[(iRow * 20 + 10) + (iCol * 2)] += + Gu1[1]*Gu2[0] + Gu1[3]*Gu2[2] + Gu1[5]*Gu2[4] + Gu1[7]*Gu2[6] + Gu1[9]*Gu2[8];
acadoWorkspace.H[(iRow * 20 + 10) + (iCol * 2 + 1)] += + Gu1[1]*Gu2[1] + Gu1[3]*Gu2[3] + Gu1[5]*Gu2[5] + Gu1[7]*Gu2[7] + Gu1[9]*Gu2[9];
}

void acado_setBlockH11_R1( int iRow, int iCol, real_t* const R11 )
{
acadoWorkspace.H[(iRow * 20) + (iCol * 2)] = R11[0];
acadoWorkspace.H[(iRow * 20) + (iCol * 2 + 1)] = R11[1];
acadoWorkspace.H[(iRow * 20 + 10) + (iCol * 2)] = R11[2];
acadoWorkspace.H[(iRow * 20 + 10) + (iCol * 2 + 1)] = R11[3];
}
...
acado_multGxGu( acadoWorkspace.QN1, &(acadoWorkspace.E[ 100 ]), &(acadoWorkspace.QE[ 100 ]) );
acado_multGxGu( acadoWorkspace.QN1, &(acadoWorkspace.E[ 110 ]), &(acadoWorkspace.QE[ 110 ]) );
acado_multGxGu( acadoWorkspace.QN1, &(acadoWorkspace.E[ 120 ]), &(acadoWorkspace.QE[ 120 ]) );
acado_multGxGu( acadoWorkspace.QN1, &(acadoWorkspace.E[ 130 ]), &(acadoWorkspace.QE[ 130 ]) );
acado_multGxGu( acadoWorkspace.QN1, &(acadoWorkspace.E[ 140 ]), &(acadoWorkspace.QE[ 140 ]) );
...
acado_multQN1d( acadoWorkspace.QN1, &(acadoWorkspace.d[ 20 ]), &(acadoWorkspace.Qd[ 20 ]) );
...
acadoWorkspace.lb[1] = (real_t)-7.8539816339744828e-001 - acadoVariables.u[1];
acadoWorkspace.lb[2] = (real_t)-1.0000000000000000e+000 - acadoVariables.u[2];
acadoWorkspace.lb[3] = (real_t)-7.8539816339744828e-001 - acadoVariables.u[3];
acadoWorkspace.lb[4] = (real_t)-1.0000000000000000e+000 - acadoVariables.u[4];
acadoWorkspace.lb[5] = (real_t)-7.8539816339744828e-001 - acadoVariables.u[5];
acadoWorkspace.lb[6] = (real_t)-1.0000000000000000e+000 - acadoVariables.u[6];
acadoWorkspace.lb[7] = (real_t)-7.8539816339744828e-001 - acadoVariables.u[7];
acadoWorkspace.lb[8] = (real_t)-1.0000000000000000e+000 - acadoVariables.u[8];
acadoWorkspace.lb[9] = (real_t)-7.8539816339744828e-001 - acadoVariables.u[9];
acadoWorkspace.ub[0] = (real_t)1.0000000000000000e+000 - acadoVariables.u[0];
acadoWorkspace.ub[1] = (real_t)7.8539816339744828e-001 - acadoVariables.u[1];
acadoWorkspace.ub[2] = (real_t)1.0000000000000000e+000 - acadoVariables.u[2];
acadoWorkspace.ub[3] = (real_t)7.8539816339744828e-001 - acadoVariables.u[3];
acadoWorkspace.ub[4] = (real_t)1.0000000000000000e+000 - acadoVariables.u[4];
acadoWorkspace.ub[5] = (real_t)7.8539816339744828e-001 - acadoVariables.u[5];
acadoWorkspace.ub[6] = (real_t)1.0000000000000000e+000 - acadoVariables.u[6];
acadoWorkspace.ub[7] = (real_t)7.8539816339744828e-001 - acadoVariables.u[7];
acadoWorkspace.ub[8] = (real_t)1.0000000000000000e+000 - acadoVariables.u[8];
acadoWorkspace.ub[9] = (real_t)7.8539816339744828e-001 - acadoVariables.u[9];

acadoWorkspace.A[0] = acadoWorkspace.E[8];
acadoWorkspace.A[1] = acadoWorkspace.E[9];

acadoWorkspace.A[10] = acadoWorkspace.E[18];
acadoWorkspace.A[11] = acadoWorkspace.E[19];
acadoWorkspace.A[12] = acadoWorkspace.E[28];
acadoWorkspace.A[13] = acadoWorkspace.E[29];

acadoWorkspace.A[20] = acadoWorkspace.E[38];
acadoWorkspace.A[21] = acadoWorkspace.E[39];
acadoWorkspace.A[22] = acadoWorkspace.E[48];
acadoWorkspace.A[23] = acadoWorkspace.E[49];
acadoWorkspace.A[24] = acadoWorkspace.E[58];
acadoWorkspace.A[25] = acadoWorkspace.E[59];

acadoWorkspace.A[30] = acadoWorkspace.E[68];
acadoWorkspace.A[31] = acadoWorkspace.E[69];
acadoWorkspace.A[32] = acadoWorkspace.E[78];
acadoWorkspace.A[33] = acadoWorkspace.E[79];
acadoWorkspace.A[34] = acadoWorkspace.E[88];
acadoWorkspace.A[35] = acadoWorkspace.E[89];
acadoWorkspace.A[36] = acadoWorkspace.E[98];
acadoWorkspace.A[37] = acadoWorkspace.E[99];

acadoWorkspace.A[40] = acadoWorkspace.E[108];
acadoWorkspace.A[41] = acadoWorkspace.E[109];
acadoWorkspace.A[42] = acadoWorkspace.E[118];
acadoWorkspace.A[43] = acadoWorkspace.E[119];
acadoWorkspace.A[44] = acadoWorkspace.E[128];
acadoWorkspace.A[45] = acadoWorkspace.E[129];
acadoWorkspace.A[46] = acadoWorkspace.E[138];
acadoWorkspace.A[47] = acadoWorkspace.E[139];
acadoWorkspace.A[48] = acadoWorkspace.E[148];
acadoWorkspace.A[49] = acadoWorkspace.E[149];
...
acadoWorkspace.QDy[25] = + acadoWorkspace.QN2[0]*acadoWorkspace.DyN[0] + acadoWorkspace.QN2[1]*acadoWorkspace.DyN[1] + acadoWorkspace.QN2[2]*acadoWorkspace.DyN[2] + acadoWorkspace.QN2[3]*acadoWorkspace.DyN[3];
acadoWorkspace.QDy[26] = + acadoWorkspace.QN2[4]*acadoWorkspace.DyN[0] + acadoWorkspace.QN2[5]*acadoWorkspace.DyN[1] + acadoWorkspace.QN2[6]*acadoWorkspace.DyN[2] + acadoWorkspace.QN2[7]*acadoWorkspace.DyN[3];
acadoWorkspace.QDy[27] = + acadoWorkspace.QN2[8]*acadoWorkspace.DyN[0] + acadoWorkspace.QN2[9]*acadoWorkspace.DyN[1] + acadoWorkspace.QN2[10]*acadoWorkspace.DyN[2] + acadoWorkspace.QN2[11]*acadoWorkspace.DyN[3];
acadoWorkspace.QDy[28] = + acadoWorkspace.QN2[12]*acadoWorkspace.DyN[0] + acadoWorkspace.QN2[13]*acadoWorkspace.DyN[1] + acadoWorkspace.QN2[14]*acadoWorkspace.DyN[2] + acadoWorkspace.QN2[15]*acadoWorkspace.DyN[3];
acadoWorkspace.QDy[29] = + acadoWorkspace.QN2[16]*acadoWorkspace.DyN[0] + acadoWorkspace.QN2[17]*acadoWorkspace.DyN[1] + acadoWorkspace.QN2[18]*acadoWorkspace.DyN[2] + acadoWorkspace.QN2[19]*acadoWorkspace.DyN[3];
...
acadoWorkspace.lbA[0] = (real_t)-1.5707963267948966e+000 - tmp;
acadoWorkspace.ubA[0] = (real_t)1.5707963267948966e+000 - tmp;
...
acadoWorkspace.lbA[1] = (real_t)-1.5707963267948966e+000 - tmp;
acadoWorkspace.ubA[1] = (real_t)1.5707963267948966e+000 - tmp;
...
acadoWorkspace.lbA[2] = (real_t)-1.5707963267948966e+000 - tmp;
acadoWorkspace.ubA[2] = (real_t)1.5707963267948966e+000 - tmp;
...
acadoWorkspace.lbA[3] = (real_t)-1.5707963267948966e+000 - tmp;
acadoWorkspace.ubA[3] = (real_t)1.5707963267948966e+000 - tmp;
...
acadoWorkspace.lbA[4] = (real_t)-1.5707963267948966e+000 - tmp;
acadoWorkspace.ubA[4] = (real_t)1.5707963267948966e+000 - tmp;
...
{
acadoVariables.x[25] = xEnd[0];
acadoVariables.x[26] = xEnd[1];
acadoVariables.x[27] = xEnd[2];
acadoVariables.x[28] = xEnd[3];
acadoVariables.x[29] = xEnd[4];
}
else if (strategy == 2) 
{
acadoWorkspace.state[0] = acadoVariables.x[25];
acadoWorkspace.state[1] = acadoVariables.x[26];
acadoWorkspace.state[2] = acadoVariables.x[27];
acadoWorkspace.state[3] = acadoVariables.x[28];
acadoWorkspace.state[4] = acadoVariables.x[29];
if (uEnd != 0)
{
...
{
acadoWorkspace.state[40] = acadoVariables.u[8];
acadoWorkspace.state[41] = acadoVariables.u[9];
}

acado_integrate(acadoWorkspace.state, 1);

acadoVariables.x[25] = acadoWorkspace.state[0];
acadoVariables.x[26] = acadoWorkspace.state[1];
acadoVariables.x[27] = acadoWorkspace.state[2];
acadoVariables.x[28] = acadoWorkspace.state[3];
acadoVariables.x[29] = acadoWorkspace.state[4];
}
}
