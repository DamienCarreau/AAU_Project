...
a[6] = ((real_t)(1.0000000000000000e+000)/(pow((cos(xd[4])),2)));
...
out[8] = (real_t)(0.0000000000000000e+000);
out[9] = a[2];
out[10] = (xd[2]*a[3]);
...
out[16] = (real_t)(0.0000000000000000e+000);
out[17] = (real_t)(0.0000000000000000e+000);
out[18] = (real_t)(0.0000000000000000e+000);
out[19] = (real_t)(1.0000000000000000e+000);
out[20] = (real_t)(0.0000000000000000e+000);
out[21] = (real_t)(0.0000000000000000e+000);
out[22] = (real_t)(0.0000000000000000e+000);
out[23] = (a[4]*a[5]);
out[24] = (real_t)(0.0000000000000000e+000);
out[25] = ((xd[2]*a[6])*a[5]);
out[26] = (real_t)(0.0000000000000000e+000);
out[27] = (real_t)(0.0000000000000000e+000);
out[28] = (real_t)(0.0000000000000000e+000);
out[29] = (real_t)(0.0000000000000000e+000);
out[30] = (real_t)(0.0000000000000000e+000);
out[31] = (real_t)(0.0000000000000000e+000);
out[32] = (real_t)(0.0000000000000000e+000);
out[33] = (real_t)(0.0000000000000000e+000);
out[34] = (real_t)(1.0000000000000000e+000);
}
...
if( 0 == run1 ) acadoWorkspace.rk_A[(tmp_index1 * 10) + (j)] -= 1.0000000000000000e+000;
...
if( 1 == run1 ) acadoWorkspace.rk_A[(tmp_index1 * 10) + (j + 5)] -= 1.0000000000000000e+000;
}
...
acadoWorkspace.rk_diffsNew2[(i * 7) + (run1)] += + acadoWorkspace.rk_diffK[i * 2]*(real_t)1.8750000000000003e-002 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)6.2500000000000003e-003;
}
}
for (run1 = 0; run1 < 2; ++run1)
{
...
for (i = 0; i < 5; ++i)
{
acadoWorkspace.rk_diffsNew2[(i * 7) + (run1 + 5)] = + acadoWorkspace.rk_diffK[i * 2]*(real_t)1.8750000000000003e-002 + acadoWorkspace.rk_diffK[i * 2 + 1]*(real_t)6.2500000000000003e-003;
}
}
...
rk_eta[4] += + acadoWorkspace.rk_kkk[8]*(real_t)1.8750000000000003e-002 + acadoWorkspace.rk_kkk[9]*(real_t)6.2500000000000003e-003;
if( run == 0 ) {
for (i = 0; i < 5; ++i)
{
for (j = 0; j < 5; ++j)
